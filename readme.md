...
>NOTE: because used helm chart creates **cluster IP service type** it was mandatory to run port forwarding to be able connect to the mysql db from outside of the K8s cluster: ```kubectl port-forward svc/demo-mysql 3306```.
